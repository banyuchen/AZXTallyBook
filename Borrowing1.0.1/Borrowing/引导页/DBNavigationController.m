...
#import "DAnmationController.h"

#define ColorFromRGB(rgbValue) [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:1.0]


@interface DBNavigationController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
- (void)viewDidLoad {
    ...
    [[UINavigationBar appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName : BlackColor, NSFontAttributeName : kFont(18)}];
    
    
    [[UINavigationBar appearance] setBarTintColor:TableColor];
    
    [[UIBarButtonItem appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName : BlackColor} forState:UIControlStateNormal];
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    if (self.viewControllers.count > 0) { // 这时push进来的控制器viewController，不是第一个子控制器（不是根控制器）
        ...
        UILabel *lable = [UILabel labelWithText:@"返回" font:kFont(15) textColor:RGBCOLOR(31, 144, 230) backGroundColor:ClearColor superView:nil];
        ...
        lable.size = CGSizeMake(31, kNavigationH);
