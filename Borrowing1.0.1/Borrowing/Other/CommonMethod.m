    ...
    dispatch_source_set_event_handler(_timer, ^{
        if(timeout<=0){ //倒计时结束，关闭
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [Verificationbtn setTitleColor:WhiteColor forState:UIControlStateNormal];
                [Verificationbtn setBackgroundImage:[UIImage imageWithColor:RGBCOLOR(68, 136, 251)] forState:UIControlStateNormal];
            ...
            if (seconds != 0) {
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    [Verificationbtn setTitleColor:GrayContentColor forState:UIControlStateNormal];
