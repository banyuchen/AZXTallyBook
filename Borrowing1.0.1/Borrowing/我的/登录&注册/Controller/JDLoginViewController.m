...
- (void)loadUI
{
    ...
    avatarImgView.image = [UIImage imageNamed:@"LOGO"];
    ...
    [avatarImgView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(KActualH(370), KActualH(244)));
    }];
    ...
    }else
    {
        ...
        UIButton *codeBtn = [UIButton buttonWithTitle:@"获取验证码" font:kFont(15) titleColor:WhiteColor backGroundColor:RGBCOLOR(68, 136, 251) buttonTag:0 target:self action:@selector(codeBtnClick:) showView:bgView];
        ...
        [codeBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.mas_equalTo(-kMargin);
            make.centerY.mas_equalTo(codeLbl.mas_centerY);
    ...
    UIView *codeLine = [UIView viewWithBackgroundColor:[XMToolClass getColorWithHexString:@"e5e5e5"] superView:bgView];
    ...
    [agreementBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(6);
        make.top.mas_equalTo(bgView.mas_bottom).mas_equalTo(kMargin);
    ...
    [loginBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.agreementBtn.mas_bottom).mas_equalTo(10);
        make.left.mas_equalTo(6);
        make.right.mas_equalTo(-6);
